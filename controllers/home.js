...
module.exports = function( async, Club, _ , Users, Message, FriendResult){
  return {
    ...
    router.get('/home', middleware.isLoggedIn, this.homepage);
  ...
  homepage: function( req, res) {
    ...
    function(callback){
      ...
      res.render('home', {title: 'DinBing - Home', user: req.user,  chunks: dataChunk, country: countrySort, data: res3, chat: res4});
    })
  },
