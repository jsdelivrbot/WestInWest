...
module.exports = function(async, Users, Message, FriendResult){
  return {
    SetRouting: function(router){
      router.get('/chat/:name', middleware.isLogged, this.getchatPage);
      router.post('/chat/:name',middleware.isLoggedIn, this.chatPostPage);
    },
    ...
    getchatPage: function(req, res){
      async.parallel([
          ...
          res.render('private/privatechat', {title: 'DinBing - Private Chat', user:req.user, data: result1, chat: result2, chats: result3, name: nameParams});
      });
    },
